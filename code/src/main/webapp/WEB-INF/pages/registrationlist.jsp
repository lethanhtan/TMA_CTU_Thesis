<%-- 
    Document   : managetour
    Created on : Mar 03, 2017, 4:50:20 PM
		...
		<div id="header">
			<div class="container">
				<div class="row">
					<!-- Logo -->
					<div class="logo">
						<a href="/TravelSystem/home" title=""> <img
				...
				<div class="col-md-12 no-padding">
					<div class="text-center visible-lg">
						<ul id="hornavmenu" class="nav navbar-nav">
							<li><a href="/TravelSystem/managetour" class="fa-gear">Quản
									Lý Tour</a></li>
							<li><a href="manageregister" class="fa-list-ul">Quản Lý
									Đăng Ký</a></li>
							<li><a href="/TravelSystem/survey" class="fa-file-text">Khảo
									Sát Ý Kiến</a></li>
