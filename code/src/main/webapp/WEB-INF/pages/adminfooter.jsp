			...
			<div id="footermenu" class="col-md-8">
				<ul class="list-unstyled list-inline">
					<li><a href="${pageContext.request.contextPath }/managetour"
						target="_blank">Quản lý tour</a></li>
					<li><a
				...
				<div class="row">
					<div id="footermenu" class="col-md-8">
						<ul class="list-unstyled list-inline">
							...
							<li><a href="${pageContext.request.contextPath }/manageregister" target="_blank">Quản lý
									đăng ký</a></li>
							<li><a href="${pageContext.request.contextPath }/survey" target="_blank">Khảo sát ý kiến</a></li>
						</ul>
					</div>
					<div id="copyright" class="col-md-4">
						<p class="pull-right">(c) 2016 NY Travel Company</p>
