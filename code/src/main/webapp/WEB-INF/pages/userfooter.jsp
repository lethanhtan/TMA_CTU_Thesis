			...
			<div class="container padding-vert-30 margin-top-60">
				<div class="row">
					...
					<div class="col-md-3 margin-bottom-20">
						<h3 class="margin-bottom-10">NY Travel Company</h3>
						<ul class="menu">
							<li><a class="fa-book" href="${pageContext.request.contextPath }/booktour">Đặt Vé</a></li>
							<li><a class="fa-tasks" href="${pageContext.request.contextPath }/blog">Blog</a></li>
							<li><a class="fa-coffee" href="${pageContext.request.contextPath }/aboutus">Về Chúng Tôi</a></li>
							<li><a class="fa-question" href="${pageContext.request.contextPath }/faq">Câu Hỏi Thường Gặp</a></li>
						</ul>
						<div class="clearfix"></div>
					</div>
					<!-- End Sample Menu -->
		...
		<div id="footer">
			<div class="container">
				<div class="row">
					<div id="footermenu" class="col-md-8">
						<ul class="list-unstyled list-inline">
							<li><a href="${pageContext.request.contextPath }/home" target="_blank">Trang Chủ</a></li>
							<li><a href="${pageContext.request.contextPath }/booktour" target="_blank">Đặt Vé</a></li>
							<li><a href="${pageContext.request.contextPath }/news" target="_blank">Tin Tức</a></li>
							<li><a href="${pageContext.request.contextPath }/aboutus" target="_blank">Chính Sách Bảo Mật</a></li>
						</ul>
					</div>
					<div id="copyright" class="col-md-4">
						<p class="pull-right">(c) 2016 NY Travel Company</p>
