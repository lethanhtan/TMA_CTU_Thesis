				...
				<s:form class="signup-page" modelAttribute="tourData"
					...
					<div class="row">
						<div class="col-sm-6">
							<label>Ngày về</label>
							<!-- Show Error -->
							<small><s:errors path="returnDate" cssStyle="color:red;" /></small>
							<!-- End Show Error -->
							<div class="input-group margin-bottom-20">
								<span class="input-group-addon"> <i
									class="fa fa-calendar"></i>
						...
						<div class="col-sm-6">
							<label>Giờ về</label>
							<!-- Show Error -->
							<small><s:errors path="returnTime" cssStyle="color:red;" /></small>
							<!-- End Show Error -->
							<div class="input-group margin-bottom-20">
								<span class="input-group-addon"> <i class="fa fa-clock-o"></i>
								</span>
					...
					<s:form modelAttribute="saleData"
					action="${pageContext.request.contextPath}/createtour"
					method="POST"
						>
						<div class="row">
					...
					<hr>
					<!-- 
					<s:form modelAttribute="scheduleData"
					action="${pageContext.request.contextPath}/createtour"
					enctype="multipart/form-data" method="POST">
						<label>Lịch trình</label>
						<small><s:errors path="detailSchedule"
								cssStyle="color:red;" /></small>
